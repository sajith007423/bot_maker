...
def create_embeddings():
    embeddings = HuggingFaceEmbeddings(model_name="{{embedding}}", model_kwargs={'device':"cuda"})
    return embeddings
'''
...
def create_llms_model():
    llm = HuggingFaceHub(repo_id="{{llm_name}}", model_kwargs={"temperature":0.5, "max_length":1000,'gpu_layers':4})
    return llm
'''
